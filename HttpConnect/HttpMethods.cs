...
namespace HttpConnect
{
    public class HttpMethods
    {
        ...
        public string HttpPost(string url, IDictionary<object, object> param, string filePath)
        {
            ...
            string header = string.Format(headerTemplate, "image_file", filePath, "text/plain");
